    ...
    return (
        <div className="w-full overflow-x-hidden font-geologica font-light text-black-1">
            <Routes>
                ...
                <Route path="/gloria" element={<Project name="Gloria" />} />
                <Route path="/katalina" element={<Project name="Katalina" />} />
                <Route path="/maria" element={<Project name="Maria" />} />
            </Routes>
            ...
            >
                ...
                <div className="relative bg-white w-[320px] lg:w-[844px] flex flex-col items-center px-5 lg:px-0 pt-[45px] pb-[86px] lg:pb-[80px] lg:pt-[80px]">
                    <button
                        ...
                        className="absolute top-5 right-5 lg:top-[38px] lg:right-[37px]"
                    >
                        <img src={IMG.times} alt="" />
                    </button>
                    <h2 className="text-2xl lg:text-4xl leading-[30px] lg:leading-[45px] mb-6 lg:mb-[27px] font-normal text-center">
                    ...
                    <div className="w-full lg:w-[535px] flex flex-col items-center">
                        ...
                        <Btn
                            theme="green"
                            className="w-full lg:w-auto !font-light mb-[7px]"
                            onClick={() => console.log("ok")}
                        >
                            Оставить заявку
                        </Btn>
                        <p className="w-full font-thin text-xs leading-[15px] text-center">
                            Нажимая на кнопку вы соглашаетесь с условиями Политики <br className="hidden lg:block" />{" "}
                            конфиденциальности
                        </p>
                    </div>
                </div>
