    ...
    return (
        <>
            <div className="mx-auto max-w-screen-lg flex flex-row relative pb-12 mt-5">
                <div className="basis-2/3 text-justify space-y-5 mr-20 text-sm">
                    <h1 className="text-5xl font-light flex justify-center">О ПРОЕКТЕ</h1>
                    <p>
                ...
                <div className="absolute top-0 left-10 text-6xl text-gray-400 linerBlack">08</div>
            </div>
        </>
    );
};
